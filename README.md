...
O objetivo deste projeto era desenvolver uma aplicação onde o usuário poderia fazer o upload de uma imagem e editá-la dentro da página no estilo de um meme. Neste projeto utilizei conhecimentos de `HTML`, `CSS` e `JavaScript`.
...
![printscreen](./meme-generator.png)
